...
<html>
     ...
     <body>
        ...
        <div class = "container-fluid">
            <div class = "row justify-content-center" style = "background-color: white; color:balck;">
        ...
        <div class = "container-fluid">
            <div class = "row justify-content-center" style = "background-color: white; color: black; height: auto">
        ...
        <div class = "row justify-content-center" style="color:black; height:100vh;">
            <div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class = "row showCase2" style = "height: 80vh;">
                     <div class = "liveNeworkShowCase">
                         <h2 class = "h2">Student Live Network</h2>
                     </div>
                </div>
            </div>
        </div>
